...
1.  <http://www.ctan.org/tex-archive/language/devanagari/velthuis>
...
Since "\~" expands to nonbreakable space it's important to set *\`\~=12* in the preamble (9).

1.  <http://cikitsa.blogspot.com/2010/09/xelatex-velthuis-encoding-and-palatal.html>
...
1.  <http://mirrors.ctan.org/language/devanagari/velthuis/doc/generic/velthuis/manual.pdf#page=6>
...
1.  <https://github.com/somadeva/RomDev>
